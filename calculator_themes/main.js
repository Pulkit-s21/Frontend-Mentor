...
buttons.map(btn => {
    btn.addEventListener("click",(e) => {
        const value = display.value.replace(/^0*/,"");
        switch(e.target.innerText){
            ...
            case '=':
                ...
                try{
                    display.value = eval(value); // eval method evaluates everything like JS and gives us a result after calcuating everything
                }catch(err){
